...
final class FacebookCommentRequestData implements FacebookRequestData
{
    const HOST = 'graph.facebook.com';
    const ENDPOINT = '/v12.0/%s/comments';
    const LIMIT = 100;
    private string $uri;
    ...
    public function __construct(
        ...
        if (is_null($nextPage) === true) {
            $query = $this->getQueryString($accessToken, $limit, $fields);
     ...
     * @return string
     */
    public function getQueryString(FacebookAccessToken $accessToken, ?int $limit = null, ?string $fields = null): string
    {
        $query = [
