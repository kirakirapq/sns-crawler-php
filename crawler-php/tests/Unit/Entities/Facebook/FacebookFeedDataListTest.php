...
/**
 * FacebookFeedDataListTest
 * @runTestsInSeparateProcesses
 */
class FacebookFeedDataListTest extends TestCase
{
    /**
     * getDataList
     * @test
    ...
    public function getDataList(bool $instanceIsNull, ?array $instanceData, array $newData, $expected): void
    {
        if ($instanceIsNull === true) {
            $actual = FacebookFeedDataList::getInstance($newData);
        } else {
            FacebookFeedDataList::getInstance($instanceData);
            $actual = FacebookFeedDataList::getInstance($newData);
        }
    ...
    {
        $actual = FacebookFeedDataList::getInstance($data);
